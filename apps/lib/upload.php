...
if (!in_array($extension, $extensions)) { //Si l'extension n'est pas dans le tableau
    $erreur = 'Vous devez uploader un fichier de type png, gif, jpg, jpeg, txt, doc, docx, odt, ppt, pptx xlsx ou csv';
}
...
if (!isset($erreur)) { //S'il n'y a pas d'erreur, on upload
    ...
    if (move_uploaded_file($_FILES['avatar']['tmp_name'], $dossier . $fichier)) { //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
        ...
        echo "<br><a href=popup-mysql_field_desc.php?id_intranet_column_info=" . $idIntranetColumnInfo."&edit_mode=1 >Retour</a>";
    }
} else {
    echo $erreur;
}
