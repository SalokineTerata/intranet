 ...
 */
$cfgPmaAbsoluteUri = 'http://intranet.dev.agis.fr/phpMyAdmin/';
...
//$cfgServers[$i]['user']          = $GLOBALS["mysql_user"];      // MySQL user
$cfgServers[$i]['user']          = 'admin';      // MySQL user
//$cfgServers[$i]['password']      = $GLOBALS["bdpass"]; // MySQL password (only needed
$cfgServers[$i]['password']      = "8ale!ne"; // MySQL password (only needed
...
// $cfgLang     = 'en';
// Loads language file
require('../phpMyAdmin/libraries/select_lang.lib.php');
