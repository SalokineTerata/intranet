...
$idClassificationRaccourcisAssociation = Lib::getParameterFromRequest(ClassificationRaccourcisAssociationModel::KEYNAME);

switch ($actionClassifcation) {

    case ClassificationRaccourcisAssociationModel::AJOUTER:
        ...
        $id_ClassificationRaccourcisAssociation = ClassificationRaccourcisAssociationModel::createNewRecordset(
...
//echo $id_fta;
        echo '
             ...
             <tr class=titre_principal><td>
                 ...
                 <br>
                 Ajout d\'une nouvelle ' . $ClassificationRaccourcisAssociationModel->getDataField(ClassificationRaccourcisAssociationModel::FIELDNAME_ID_CLASSIFICATION_RACCOURCIS)->getFieldLabel()
        . ' </td></tr>
             </table>
             <' . $html_table . '>
             <tr><td width=\'20%\'>
