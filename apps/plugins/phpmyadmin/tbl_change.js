...
function openCalendar(params, form, field, type) {
    window.open("../lib/calendar.php?" + params, "calendar", "width=400,height=200,status=yes");
...
var month_names = new Array("Janvier","Fevrier","Mars","Avril","Mai","Juin","Juillet","Ao�t","Septembre","Octobre","Nomvembre","D�cembre");
