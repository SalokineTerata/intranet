 ...
 */
     ...
     case "rewrite":
          ...
          if(${$module."_modification"} >= 1)
          {
              mysql_table_operation("annexe_emballage", $action);
          }
          ...
          //Mise à jour des FTA associées
                 ...
                 $req = "SELECT DISTINCT salaries_mail.id_service, salaries_mail.id_user, "
                      ...
                      . "FROM salaries AS salaries_createur, salaries AS salaries_mail, fta, fta_etat, "
                        ...
                        . "intranet_actions AS action_definition, intranet_actions AS action_diffusion, fta_processus, access_arti2 "

                      . "WHERE salaries_createur.id_user=createur_fta "

                        //Recherche de l'accès au chapitre "Définition"
                        . "AND salaries_createur.id_service=salaries_mail.id_service "
                        ...
                        . "AND `action_definition`.`id_intranet_actions` = `fta_processus`.`id_intranet_actions` "
                        . "AND fta_processus.id_fta_processus = 1 "
