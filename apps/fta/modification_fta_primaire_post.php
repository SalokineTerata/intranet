...
if ($idFtaPrimaire) {
    ...
    $modelFta->getDataField(FtaModel::FIELDNAME_DOSSIER_FTA_PRIMAIRE)->setFieldValue($idFtaDossier);
    
    $arrayFtaDossierChampsVerrouiller = DatabaseOperation::convertSqlStatementWithoutKeyToArray(
                    "SELECT DISTINCT " . FtaVerrouillageChampsModel::FIELDNAME_TABLE_NAME
                    . "," . FtaVerrouillageChampsModel::FIELDNAME_FIELD_NAME
                    . "," . FtaVerrouillageChampsModel::FIELDNAME_DOSSIER_FTA_PRIMAIRE
                    . "," . FtaVerrouillageChampsModel::FIELDNAME_FIELD_LOCK
                    . " FROM " . FtaVerrouillageChampsModel::TABLENAME
                    . " WHERE " . FtaVerrouillageChampsModel::FIELDNAME_DOSSIER_FTA_PRIMAIRE . "=" . $idFtaDossier
    );
    if ($arrayFtaDossierChampsVerrouiller) {
        
    } else {
        $arrayIntranetColumInfoLockField = "";
    }
