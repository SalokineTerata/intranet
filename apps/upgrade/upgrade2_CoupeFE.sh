...
echo "*** Requêtes SQL:"
php ./apps/upgrade/upgrade2_CoupeFe.php $DB_NAME_V3 $DB_NAME_ORIG $DB_NAME_STRUCTURE $MYSQL_SERVER_NAME_DEST $MYSQL_USER_NAME_DEST $MYSQL_USER_PASSWORD_DEST $ID_FTA_WORKFLOW
