<?php
/* $Id: tbl_change.php,v 1.86.2.3 2002/08/11 21:52:33 rabus Exp $ */
...
//Modifié par Boris Sanègre 2003.04.08
...
if (!empty($message)) {
    if (isset($goto)) {
        ...
        $goto          = 'tbl_properties.php'
                       . '?lang=' . $lang
                       . '&amp;application_courante=' . $GLOBALS['application_courante']
                       . '&amp;server=' . $server
                       . '&amp;db=' . urlencode($db)
...
if (isset($primary_key)) {
    ...
    }// end if (modifications boris sanegre)
    else
    {
       ...
       $goto              = 'sql.php'
                           ...
                           . '&amp;table=' . urlencode($table)
                           . '&amp;sql_query=' . $sql_query;
    }//end else (modifications boris sanegre)
}
else
{
...
echo
"
  <input type=hidden name=application_courante value="
  . $GLOBALS['application_courante']
  ." />
";
if (isset($primary_key)) {
    ?>
...
for ($i = 0; $i < $fields_cnt; $i++) {
    ...
    if (strstr($row_table_def['True_Type'], 'text')) {
        ...
        <td bgcolor="<?php echo $bgcolor; ?>">
            ...
            <textarea name="fields[<?php echo urlencode($field); ?>]" rows="<?php echo $cfgTextareaRows; ?>" cols="<?php echo $cfgTextareaCols; ?>" wrap="virtual" dir="<?php echo $text_dir; ?>" <?php echo $chg_evt_handler; ?>="return unNullify('<?php echo urlencode($field); ?>')" tabindex="<?php echo $i; ?>"><?php echo $special_chars; ?></textarea>
        </td>
        <?php
        echo "\n";
    ...
    // We don't want binary data destroyed
        ...
        <td bgcolor="<?php echo $bgcolor; ?>">
            <?php echo $backup_field . "\n"; ?>
            <textarea name="fields[<?php echo urlencode($field); ?>]" rows="<?php echo $cfgTextareaRows; ?>" cols="<?php echo $cfgTextareaCols; ?>" wrap="virtual" dir="<?php echo $text_dir; ?>" <?php echo $chg_evt_handler; ?>="return unNullify('<?php echo urlencode($field); ?>')" tabindex="<?php echo $i+1; ?>" ><?php echo $special_chars; ?></textarea>
        </td>
            <?php
        } else {
            if ($len < 4) {
