...
if ($paramIdClaasifElement) {
    ...
    $htmlTableClassificationElement = ClassificationActiviteFamilleVentesArcadiaModel::getHtmlTableClassificationActiviteFamilleVentesArcadia($idClassifcationFta2Activite);
} else {
