...
//Calcul du taux
$taux_temp=fta_taux_validation($id_fta);
...
if($id_fta)
{
       ...
       <tr class=titre>
           <td>
           ".mysql_field_desc("fta_processus", "nom_fta_processus")."
           </td>
           <td>
           ".mysql_field_desc("fta_processus", "service_fta_processus")."
           </td>
           <td>
           Taux
           </td>
...
/*   //$id_access_arti2; //Clef récupérée précédement
  ...
  foreach ($tab as $id_fta_processus => $taux)
  {
       ...
       $id_fta_processus_etat=fta_processus_etat($id_fta, $id_fta_processus);
       mysql_table_load("fta_processus_etat");
