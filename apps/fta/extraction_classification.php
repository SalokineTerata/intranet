...
//Initialisation première boucle:3
    ...
    function recursifOne($paramStartValue, $htmlResult, $paramNameOfBDDOrigin) {
        $reqTableClassifRoot = "SELECT classification_arborescence_article.id_classification_arborescence_article, "
                ...
                . "FROM " . $paramNameOfBDDOrigin . ".classification_arborescence_article, " . $paramNameOfBDDOrigin . ".classification_arborescence_article_categorie_contenu, "
                . "" . $paramNameOfBDDOrigin . ".classification_arborescence_article_categorie "
...
//$connect = new PDO($hostname_connect, $username_connect, $password_connect); //connection � la base de donn�e si sa echoue sa retourne une erreur. 
    ...
    DatabaseOperation::execute(
            "CREATE TABLE " . $paramNameOfBDDTarget . ".classification_fta2 LIKE  " . $paramNameOfBDDStructure . ".classification_fta2;"
    );
