<?php
/* $Id: common.lib.php,v 1.72.2.3 2002/05/01 09:30:59 loic1 Exp $ */
...
if (!defined('PMA_COMMON_LIB_INCLUDED')){
     ...
     * below).
     */
    include('../phpMyAdmin/libraries/defines.lib.php');
                          ...
                          $is_modify_link = TRUE, $back_url = '')
    {
        ...
        if (empty($GLOBALS['is_header_sent'])) {
            ...
            include('../phpMyAdmin/header.inc.php');
        }
        ...
        include('../phpMyAdmin/footer.inc.php');
        exit();
     ...
     */
        ...
        include('../phpMyAdmin/libraries/auth/' . $cfgServer['auth_type'] . '.auth.lib.php');
        if (!PMA_auth_check()) {
            PMA_auth();
        } else {
            PMA_auth_set_user();
