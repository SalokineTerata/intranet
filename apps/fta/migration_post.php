...
switch ($action) {
    case "2_4_0_doublon_emballage_UVC":
        ...
        $req = "SELECT DISTINCT fta_conditionnement_double.id_fta, LIBELLE
                FROM fta_conditionnement, fta_conditionnement AS fta_conditionnement_double, fta
                WHERE fta.id_fta = fta_conditionnement_double.id_fta
                ...
                AND fta_conditionnement_double.quantite_par_couche_fta_conditionnement = fta.NB_UNIT_ELEM"
        ;
    ...
    case "2_3_0_recreation_din_nomenclature":
        ...
        $req = "SELECT id_fta_nomenclature FROM fta_nomenclature";
        $array = DatabaseOperation::convertSqlStatementWithoutKeyToArray($req);
        foreach ($array as $rows) {
    ...
    case "2_3_0_archivage_fta":
        ...
        $req = "SELECT id_fta,CODE_ARTICLE,LIBELLE,date_derniere_maj_fta "
                . ", `fta_migration_import_articles_actifs`.`code_agrologic` "
                . "FROM fta, fta_etat, `fta_migration_import_articles_actifs` RIGHT JOIN `fta` "
                . "ON `fta_migration_import_articles_actifs`.`code_agrologic` = `fta`.`CODE_ARTICLE` "
                . "WHERE (`fta_migration_import_articles_actifs`.`code_agrologic` IS NULL) "
                . "AND (`fta`.`CODE_ARTICLE` IS NOT NULL) "
