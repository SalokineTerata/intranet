...
global $mysql_user;      //voir session.php
global $bdpass;          //Mot de passe NIV I - voir session.php
global $mysql_database;  //voir session.php
/* echo $application_courante;
echo $GLOBALS["mysql_user"];
 */
//global $nom_table;
