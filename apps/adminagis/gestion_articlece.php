...
/* Recuperation du numéro d'article et si c coche ou non */
    $req="select * from articlece where numserce='$numser'";
    //echo"$req";
...
/* Recopie de l'enregistrement dans ARTICLECE */
          ...
          $req2="insert into archivece (numartce, imgce, titrece, txtce,
          placeinfoce, datecrea, id_userce, numserce, datearchive, id_userarch)
          values ('$numart', '$imgce', '$titrece', '$txtce', '$placeinfoce',
          '$datecrea', '$id_userce', '$numser', now(), '$id_user')";
    //echo"$req2";
          $result2=DatabaseOperation::query($req2);
/* Effacement de l'enregistrement dans ARCHIVECE */
          $req2="delete from articlece where numartce='$numart'";
          $result2=DatabaseOperation::query($req2);
        }
        $i++;
      }
    ...
    <td>
      <table width="600" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="512"><img src="../images_pop/gestion_articlece.gif" width="500" height="62"></td>
      ...
      <br><table width="98%" border="1" cellspacing="0" cellpadding="4" align=center bgcolor="#FFE5B2">
        <tr>
...
<?php
/* Creation du tableau */
  $req="select * from articlece where numserce='$numserce'";
  $result=DatabaseOperation::query($req);
  $num=mysql_num_rows($result);
  if ($num != 0)
  {
