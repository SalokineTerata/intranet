...
class ClassificationActiviteSousFamilleArcadiaModel extends AbstractModel {
    ...
    public static function getHtmlListeClassificationActiviteSousFamilleArcadia($paramIdFta, $paramIdClassificationFta2, $paramIsEditable) {
        ...
        $htmlList->initAbstractHtmlSelect(
                $HtmlTableName
                , $htmlList->getLabel()
                , $ftaModel->getDataField(FtaModel::FIELDNAME_ID_ARCADIA_SOUS_FAMILLE)->getFieldValue()
                , $ftaModel->getDataField(FtaModel::FIELDNAME_ID_ARCADIA_SOUS_FAMILLE)->isFieldDiff()
